...
%code{
   ...
   analizer::YYLTYPE LLCAST(analizer::location x) { return analizer::YYLTYPE({(x.begin.line), (x.begin.column), (x.end.line), (x.end.column)} ); }
...
main_class
      : CLASS IDENTIFIER LBRAC STATIC VOID MAIN LBRACKET STRING LSQUAREBRACKET RSQUAREBRACKET IDENTIFIER RBRACKET LBRACE statement RBRACE RBRACE
...
void
analizer::Parser::error( const location_type &l, const std::string &err_message )
{
